...
--Check that Conky has been running for at least 5s -- boilerplate code
  ...
  DrawLine(cr,0,0,355,0,8)
  DrawLine(cr,355,0,0,25,4)
  DrawLine(cr,100,75,170,0,4)
  
  draw_clock_hands(cr,clock_x,clock_y)

  --draw network lines
  DrawLine(cr,0,155,410,0,4)
  DrawLine(cr,410,155,0,23,4)
  
    --draw cpu temp lines
  DrawLine(cr,0,320,360,0,4)
  DrawLine(cr,360,320,0,42,4)
  
  --draw cpu temp bars
  DrawBars(cr,250,470,30,100,1,rgb_to_r_g_b(0x607d8b))
  DrawBars(cr,290,470,30,100,2,rgb_to_r_g_b(0xe53935))
  
  --draw mem temp bars
  DrawLine(cr,0,585,243,0,4)
